...
RSpec.describe TopicsController, type: :controller do
  # describe "#index" do
  #   let!(:all_topics) { Topic.all }
  #   before { get :index, user_id: topic.user.id, id: topic.id }
  #
  #   it "assigns @topics" do
  #     expect(assigns(:topics)).to eq(all_topics)
  #   end
  #
  ...
  #
  #   before do
  #     get :show, user_id: topic.user.id, id: topic.id
  #   end
  #
  #   it "assigns @user" do
  #     expect(assigns(:user)).to eq(topic.user_id)
  #   end
  #
  #   it "assigns @topic" do
